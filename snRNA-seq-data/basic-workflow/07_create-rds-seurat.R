...
base_dir <- '/Users/maureen/Documents/projects/lukens-lab/jess/Thanos_AD-Sting_snRNAseq/analysis-4/global-sting-ko/2024-07-25_export/global/full'

## Define paths for csv exports of original AnnData
counts_file <- file.path(base_dir, 'counts-matrix.csv')
log1p_file <- file.path(base_dir, 'log1p-matrix.csv')
normalized_file <- file.path(base_dir, 'normalized-matrix.csv')
cell_metadata_file <- file.path(base_dir, 'cell-metadata.csv')
feature_metadata_file <- file.path(base_dir, 'feature-metadata.csv')
pca_file <- file.path(base_dir, 'pca.csv')
latent_rep_file <- file.path(base_dir, 'latent_representation.csv')
umap_file <- file.path(base_dir, 'umap.csv')
...
## Create SeuratObject
seurat_object <- CreateSeuratObject(counts = counts_matrix, project = "2024_Sting1-globalKO-scRNA-seq")
...
seurat_object@meta.data <- seurat_object@meta.data %>%
  dplyr::rename(leiden = leiden_scVI)
...
save_dir = '/Users/maureen/Documents/projects/lukens-lab/jess/Thanos_AD-Sting_snRNAseq/analysis-4/global-sting-ko/2024-07-25_export/global/full'

saveRDS(seurat_object, file = file.path(save_dir, "2024-07-25_sting-globalKO-full.rds"))
...
base_dir <- '/Users/maureen/Documents/projects/lukens-lab/jess/Thanos_AD-Sting_snRNAseq/analysis-4/global-sting-ko/2024-07-25_export/global/hvg'
...
save_dir = '/Users/maureen/Documents/projects/lukens-lab/jess/Thanos_AD-Sting_snRNAseq/analysis-4/global-sting-ko/2024-07-25_export/global/hvg'

saveRDS(seurat_object, file = file.path(save_dir, "2024-07-25_sting-globalKO-hvg.rds"))
